# Contribute to the Tangle Deployment Tools

This document describes how to contribute to the Tangle Deployment Tools.
...
To contribute to the Tangle Deployment Tools on GitHub, you can:
...
- **Ensure the bug was not already reported** by searching on GitHub under [**Issues**](https://github.com/iotaledger/tangle-deployment/issues). If the bug has already been reported **and the issue is still open**, add a comment to the existing issue instead of opening a new one.

**Note:** If you find a **Closed** issue that seems similar to what you're experiencing, open a new issue and include a link to the original issue in the body of your new one.

### Submitting A Bug Report

To report a bug, [open a new issue](https://github.com/iotaledger/tangle-deployment/issues/new), and be sure to include as many details as possible, using the template.
...
**Ensure the feature has not already been suggested** by searching on GitHub under [**Issues**](https://github.com/iotaledger/tangle-deployment/issues).
